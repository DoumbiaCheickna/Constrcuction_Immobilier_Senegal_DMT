...
import { collection, addDoc, doc, getDoc, updateDoc, deleteDoc, query, orderBy, getDocs, onSnapshot, serverTimestamp } from "firebase/firestore";
import { db } from "../firebase/config";


// properties
export const propertiesCol = () => collection(db, "properties");
export async function createProperty(data) { return await addDoc(propertiesCol(), { ...data, createdAt: serverTimestamp() }); }
...
export async function createMessage(data) { return await addDoc(messagesCol(), { ...data, createdAt: serverTimestamp() }); }
...
export async function addVisitor(data) { return await addDoc(visitorsCol(), { ...data, createdAt: serverTimestamp() }); }
...
// email logs
export const emailLogsCol = () => collection(db, "emailLogs");
export async function addEmailLog(data) { return await addDoc(emailLogsCol(), { ...data, createdAt: serverTimestamp() }); }