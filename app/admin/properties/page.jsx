...
//     { id: 1, type: "Appartement", prix: "250 000 F", quartier: "Ouakam" },
//     { id: 2, type: "Studio", prix: "120 000 F", quartier: "Sicap" },
//   ]);
...
//         <Link className="px-4 py-2 bg-blue-600 text-white rounded-lg" href="/admin/properties/new">+ Nouveau</Link>
//       </div>
...
//                 <Link href={`/admin/properties/${item.id}`} className="text-blue-600 mr-3">Modifier</Link>
